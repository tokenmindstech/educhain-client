...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="relative h-fit min-h-screen w-full bg-radial-about flex items-center justify-center py-24 px-10 sm:px-5 3xl:px-0"
    >
      <Card className="relative container mx-auto bg-linear-to-b from-[#1F5ADC] to-primary grid grid-cols xl:grid-cols-2 p-10 sm:p-15 items-center rounded-4xl">
        {/* Overlay */}
        <Image
        ...
        <div className="text-white font-montserrat space-y-8">
          ...
          <p className="text-sm sm:text-base">
            EduChain is a blockchain infrastructure layer for global education,
            not just a token for one academy. Any university, online school,
            bootcamp, or independent instructor can use EduChain to issue
            tamper-proof certificates, verify skills, and build on-chain
            academic identities for their learners. It acts as a universal token
            standard for education credentials in Web3.
          </p>
